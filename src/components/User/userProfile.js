...
//       if (response.status === 403) {
//         message.error("You don't have permission to update this profile");
//         return;
//       }
  ...
  const generateUserItems = () => {
    if (isEditMode) {
      ...
      return [
        ...
        {
          label: "Phone Number",
          children: user.phoneNumber ? user.phoneNumber.replace(
            /(\d{3})(\d{3})(\d{4})/,
            "($1) $2-$3"
          ) : "No data",
        },
        {
          label: "Date of Birth",
          children: user.dateOfBirth ? new Date(user.dateOfBirth).toLocaleDateString("en-US", {
            month: "2-digit",
            day: "2-digit",
            year: "numeric",
          }) : "No data",
        ...
        {
          label: "Gender",
          children: user.gender ? user.gender.charAt(0).toUpperCase() + user.gender.slice(1) : "No data",
        },
      ];
    }
  };
